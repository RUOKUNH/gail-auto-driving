...
class MATrafficSim:
    def __init__(self, scenarios, agent_number, envision=False):
    ...
    def reset(self, vehicle_id=None):
        ...
        self.vehicle_itr = np.random.randint(len(self.vehicle_ids))
...
if __name__ == "__main__":
    env = MATrafficSim(["../scenarios/ngsim"], agent_number=10)
    obs = env.reset()
    pdb.set_trace()
    done = {}
    n_steps = 100
